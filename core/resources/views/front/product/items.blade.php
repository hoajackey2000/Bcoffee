                    ...
                    <div class="row justify-content-start">
                        ...
                        <div class="col-lg-4 col-md-7 col-sm-8">
                            <div class="single-pricing text-center mt-30">
                                ...
                                <h3 class="title">{{$be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : ''}}{{convertUtf8(number_format($product->current_price,0,',','.'))}}{{$be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : ''}}
