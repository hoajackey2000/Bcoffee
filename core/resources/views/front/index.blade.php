                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-7">
                            <div class="banner-content">
                                <h1 data-animation="fadeInUp" data-delay="1000s"  class="title" style="color: #{{$slider->title_color}};">{{convertUtf8($slider->title)}}</h1>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{$keys == 0 ? 'active' : ''}}" id="{{$category->slug}}-tab" data-toggle="pill" href="#{{$category->slug}}" role="tab" aria-controls="{{$category->slug}}" aria-selected="true">
                                            ...
                                            {{-- @if (file_exists($path) && $category->image) --}}
                                                ...
                                                <img style="width:74px;height: 60px;" src="{{asset('assets/front/img/category/'.$category->image)}}" alt="menu">
                                            {{-- @endif --}}
                                            ...
                                            <div class="food-menu-items">
                                                <div class="single-menu-item mt-30">
                                                    ...
                                                    <div class="menu-price-btn">
                                                        ...
                                                        <del>  {{$be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : ''}}{{convertUtf8(number_format($product->previous_price,0,',','.'))}}{{$be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : ''}}</del>
                                                        @endif
                                                    </div>
                        ...
                        <div class="special-items">
                            @foreach ($special_product as $sproduct)
                                <div class="good-food-item white-bg text-center wow fadeIn animated" data-wow-duration="2000ms" data-wow-delay="0ms">
                                    ...
                                    <h3 class="title">{{$be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : ''}}{{convertUtf8(number_format($product->current_price,0,',','.'))}}{{$be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : ''}}</h3>
    ...
    @if($bs->table_section == 1)
        <section class="reservation-area bg_cover">
            <div id="map">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d244.928442764967!2d106.63895156734691!3d10.82240009372175!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317529f33b4d0ca3%3A0xbcda18ec9c93b86f!2sC%C3%94NG%20TY%20TNHH%20BANKUS!5e0!3m2!1svi!2s!4v1671178483369!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            </div>
            <div class="container">
                <div class="row justify-content-center">
