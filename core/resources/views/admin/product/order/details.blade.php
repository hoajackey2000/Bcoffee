...
<div class="row">
          ...
          <div class="card-body pt-5 pb-5">
             <div class="payment-information">
                 ...
                 <div class="row mb-2">
                     ...
                     <div class="col-lg-6">
                        {{$order->currency_symbol_position == 'left' ? $order->currency_symbol : ''}} {{number_format($order->total,0,',','.')}} {{$order->currency_symbol_position == 'right' ? $order->currency_symbol : ''}}
                     </div>
                 </div>
                 ...
                 <div class="row mb-2">
                     ...
                     <div class="col-lg-6">
                        {{$order->currency_symbol_position == 'left' ? $order->currency_symbol : ''}} {{number_format($order->shipping_charge,0,',','.')}} {{$order->currency_symbol_position == 'right' ? $order->currency_symbol : ''}}
                     </div>
                 </div>
   ...
   <div class="col-lg-12">
    <div class="card">
       <div class="card-header">
          <h4 class="card-title">{{__('Order Product')}}</h4>
       </div>
       <div class="card-body">
             ...
             <table class="table table-bordered">
                ...
                <tbody>
                   ...
                   <tr>
                      ...
                      <td>{{$order->currency_symbol_position == 'left' ? $order->currency_symbol : ''}}{{number_format($item->price,0,',','.')}}{{$order->currency_symbol_position == 'right' ? $order->currency_symbol : ''}}</td>
                      <td>{{$order->currency_symbol_position == 'left' ? $order->currency_symbol : ''}}{{number_format($item->price * $item->qty,0,',','.')}}{{$order->currency_symbol_position == 'right' ? $order->currency_symbol : ''}}</td>
                   </tr>
                   @endforeach
                </tbody>
             </table>
