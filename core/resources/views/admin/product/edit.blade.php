              ...
              <form id="ajaxForm" class="" action="{{route('admin.product.update')}}" method="post" enctype="multipart/form-data">
                   ...
                   <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="title"  placeholder="{{__('Enter Title')}}" value="{{$data->title}}">
                ...
                <div class="row">
                   ...
                   <div class="col-lg-6">
                      <div class="form-group">
                         ...
                         <input type="number" class="form-control ltr" name="stock"  placeholder="{{__('Enter Product Stock')}}" value="{{$data->stock}}">
                ...
                <div class="row">
                   <div class="col-lg-6">
                      ...
                      <input type="number" class="form-control ltr" name="current_price" value="{{number_format($data->current_price,0,',','')}}"  placeholder="{{__('Enter Current Price')}}">
                   ...
                   <div class="col-lg-6">
                      <div class="form-group">
                         ...
                         <input type="number" class="form-control ltr" name="previous_price" value="{{$data->previous_price}}" placeholder="{{__('Enter Previous Price')}}">
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <div class="form-group">
                         ...
                         <textarea name="summary" id="summary" class="form-control" rows="4" placeholder="{{__('Enter Product Summary')}}">{{$data->summary}}</textarea>
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <div class="form-group">
                         ...
                         <textarea class="form-control summernote" name="description" placeholder="{{__('Enter description')}}" data-height="300">{{replaceBaseUrl($data->description)}}</textarea>
