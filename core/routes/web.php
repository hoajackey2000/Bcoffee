...
// Route::get('/dat_hang',[
// 	'as'=>'dathang',
// 	'uses'=>'Payment\PaymentATMController@getCheckout'
// ]);

// Route::post('/checkout_item',[
// 	'as'=>'dathang',
// 	'uses'=>'Payment\PaymentATMController@postCheckout'
// ]);
...
Route::middleware(['setlang'])->group(function () {
    ...
    // // CHECKOUT SECTION COD
    Route::get('/checkout_item', 'Front\ProductController@getCheckout')->name('front.checkout_item');
    Route::get('/product/checkout_item/return', 'Payment\product\PaymentCODController@payreturn')->name('product.checkout_item.return');
    // Route::get('/product/checkout_item/cancle', 'Payment\product\PaymentCODController@paycancle')->name('product.checkout_item.cancle');
    // Route::get('/product/checkout_item/notify', 'Payment\product\PaymentCODController@notify')->name('product.checkout_item.notify');
    Route::post('/product/checkout_item/submit', 'Payment\product\PaymentCODController@store')->name('product.checkout_item.submit');
// // CHECKOUT SECTION COD ENDS
